...
using namespace aos::emulator;


//Emulator::Ptr ae::emulator::create(const string& name, const aos::library::Game& game)
//{
//	return ae::Registry<Emulator::Ptr,creator_fn>::instance().create(name)(game);
//}
...
void aos::emulator::Emulator::run()
{
